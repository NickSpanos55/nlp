...
class SimpleSelfAttentionModel(nn.Module):
    ...
    def __init__(self, output_size, embeddings, max_length=60):
        ...
        self.position_embedding_table = nn.Embedding(self.max_length, dim).to('cuda')
    ...
    def forward(self, x):
        ...
        pos_emb = self.position_embedding_table(torch.arange(T).to('cuda'))  # (T,C)
...
class Block(nn.Module):
    ...
    def __init__(self, n_head, head_size, n_embd):
        ...
        self.sa = MultiHeadAttention(n_head, head_size, n_embd,0.0)
...
class TransformerEncoderModel(nn.Module):
    def __init__(self, output_size, embeddings, max_length=60, n_head=3, n_layer=3):
        ...
        head_size = dim // self.n_head
        #Define Blocks of MultiHeaded Attention
